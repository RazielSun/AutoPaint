...
void FAutoPaintTexturePatchGPUInterface::Dispatch_RenderThread(FRHICommandListImmediate& RHICmdList, const FAutoPaintTexturePatchDispatchParams& Params)
{
	...
	EShaderBlendMode BlendMode = EShaderBlendMode::Max;
...
void FAutoPaintTexturePatchGPUInterface::Dispatch_GameThread(const FAutoPaintTexturePatchDispatchParams& Params)
{
...
void FAutoPaintTexturePatchGPUInterface::Dispatch(const FAutoPaintTexturePatchDispatchParams& Params)
{
